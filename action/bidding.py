...
def take_bidding_action():
    ...
    if is_str_back(share_min):
        ...
        bidding_process(share_min)


def get_bidding_max(share_min):
    return share_min + roll_dice(10)
    ...
    if start_bidding:
        while True:
            ...
            if is_str_yes(result):
                print(output.cait_bid_won_text(new_bid))
                break
